...
*/
#define WL_SSID 		 "---------"	   			    /*! \def SSID (nome) della rete wifi a cui il dispositivo deve connettersi */
#define WL_PASSWORD  "------------------" 		/*! \def Password della rete wifi a cui il dispositivo deve connettersi */
...
#define IO_LCD       0x26                     /*! \def Indirizzo I2C su cui comunica il display LCD */
...
LiquidCrystal_I2C lcd(IO_LCD,20,4);     /*!< Istanza del display LCD */
...
void setup()
{
   ...
   * Stampa sul display le informazioni di connessione
	 */
  lcd.setCursor(0,0);
...
void loop()
{
    ...
    lcd.print(bufhum);
    lcd.setCursor(9, 3);
    lcd.print(String(bufpress / 100, 2));
	}
